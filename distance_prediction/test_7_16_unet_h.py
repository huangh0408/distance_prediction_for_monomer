...
#modelfile='model-07_09_2019_22_26_32_060277.h5'
#modelfile='model-07_11_2019_10_35_18_250285.h5'
#modelfile='model-07_15_2019_23_28_55_733985.h5'
#modelfile='model-07_16_2019_09_08_14_952723.h5'
modelfile='model-07_16_2019_23_59_32_859547.h5'
...
#        print('ME for ' + str(i) + ' - ' + str(pdb_list[i]) + ' = %.2f' % sum_me)
        if plot_count > 0:
            plot_count -= 1
            for j in range(0, L):
                for k in range(0, L):
...
#    split2 = int(0.30 * len(pdb_list))
#    split3 = int(0.90 * len(pdb_list))
...
#    model.compile(loss = 'msle', optimizer = 'rmsprop', metrics = ['mae'])
  ...
  #  history = model.fit(XTRAIN, YTRAIN, verbose = 1, batch_size = 2, epochs = 150, validation_data=(XVALID, YVALID), callbacks=[es, mc])
